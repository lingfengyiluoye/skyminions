 ...
 * 水在西侧 1 格、岩浆源在东侧 2 格，两股流体在中间生成点相遇产出圆石；
...
public final class GeneratorStrategy implements MinionWorkStrategy {
     ...
     *       水在西 1 格、岩浆源在东 2 格（岩浆流 1 格后与水相遇，避免岩浆源触水变黑曜石）；</li>
    ...
    private WorkOutcome idealLayoutWork(WorkContext ctx) {
        ...
        Block water = gen.getRelative(BlockFace.WEST);
        Block lava = gen.getRelative(BlockFace.EAST, 2);
